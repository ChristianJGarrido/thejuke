...
public class PlayListService {
	...
	public List<PlayList> findAllPlayLists() {
        ...
        TypedQuery<PlayList> typedQuery = entityManager.createNamedQuery(PlayList.FIND_ALL, PlayList.class);
	...
	/**
	 * Searches database for playlists with the specified Admin, returns a playlist list
	 * @param a
	 * @return List<PlayList>
	 */
	public List<PlayList> findByAdmin(Admin a) {
	     ...
	     TypedQuery<PlayList> typedQuery = entityManager.createNamedQuery(PlayList.FIND_BY_ADMIN_ID, PlayList.class);
	...
	public List<PlayList> findByPlayListName(String name) {
	     ...
	     TypedQuery<PlayList> typedQuery = entityManager.createNamedQuery(PlayList.FIND_BY_PLAYLIST_NAME, PlayList.class);
	...
	/**
	 * Searches through database based on a keyword and returns a playlist list that is similar to name or admin name
	 * @param keyword
	 * @return List<PlayList>
	 */
	public List<PlayList> searchPlayLists(String keyword) {
		 ...
		 TypedQuery<PlayList> typedQuery = entityManager.createNamedQuery(PlayList.SEARCH, PlayList.class);

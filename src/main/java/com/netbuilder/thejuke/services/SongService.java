...
public class SongService implements Serializable {
	...
	public void listSongs() {
		List<Song> list = entityManager.createQuery("Select s from Song s",
	...
	public List<Song> findAllSongs() {
		...
		TypedQuery<Song> typedQuery = entityManager.createNamedQuery(
				Song.FIND_ALL, Song.class);
	...
	public Song persistSong(Song song) {
		...
		if (song.getGenre() != null
				&& (Integer) (song.getGenre().getId()) == null) {
	...
	/**
	 * Searches database for songs with the specified Genre and returns a song
	 * list
	 * 
	 * @param g
	 * @return List<Song>
	...
	public List<Song> findByGenre(Genre g) {
		...
		TypedQuery<Song> typedQuery = entityManager.createNamedQuery(
				Song.FIND_BY_GENRE_ID, Song.class);
	...
	public List<Song> findBySongName(String name) {
		...
		TypedQuery<Song> typedQuery = entityManager.createNamedQuery(
				Song.FIND_BY_SONG_NAME, Song.class);
	...
	/**
	 * Searches through database based on a keyword and returns a song list that
	 * is similar to name or genre
	 * 
	 * @param keyword
	 * @return
	 */

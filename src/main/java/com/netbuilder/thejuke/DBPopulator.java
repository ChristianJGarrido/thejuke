...
@Startup
@Loggable
@DataSourceDefinition(className = "org.apache.derby.jdbc.EmbeddedDataSource", name = "java:global/jdbc/applicationPetstoreDS", user = "root", password = "P4ssword", databaseName = "thejukedb", properties = { "connectionAttributes=;create=true" })
public class DBPopulator {
	// private static EntityManagerFactory emf =
	// Persistence.createEntityManagerFactory("TheJuke");
